...
const envId = "https://twikoo.redish101.top";
const twikooJs = ref<any>(null);
...
function initLightGallery() {
  ...
  for (var i = 0; i < commentContents.length; i++) {
    ...
    if (imgEls.length > 0) {
      ...
      window.lightGallery(commentItem, {
        selector: ".tk-lg-link",
        share: false,
      });
    }
...
<template>
  <div class="comment-container vp-raw">
    ...
    <component
      :is="'script'"
      defer
      src="https://fastly.jsdelivr.net/npm/katex@0.12.0/dist/katex.min.js"
    ...
    <component
      :is="'script'"
      defer
      src="https://fastly.jsdelivr.net/npm/katex@0.12.0/dist/contrib/auto-render.min.js"
    ...
    <link
      rel="stylesheet"
      href="https://fastly.jsdelivr.net/npm/lightgallery@2.1.8/css/lightgallery.css"
      integrity="sha384-U8ohOXEVyF0NGY2LQnH83V4wGxOmFhim4U5xhfE/WDCHdPO2iUKPPYkhpDl9U/Yf"
      crossorigin="anonymous"
    />
    <component
      :is="'script'"
      src="https://fastly.jsdelivr.net/npm/lightgallery@2.1.8/lightgallery.min.js"
    ...
    <component
      :is="'script'"
      src="https://fastly.jsdelivr.net/npm/twikoo@1.6.39/dist/twikoo.min.js"
      crossorigin="anonymous"
      ref="twikooJs"
    ></component>
  </div>
